<div>
      ...
      <div className="row">
        ...
        <div className="col-lg-6 pr-0 pl-4">
          <div className="charina-section-title">
            ...
            <h1 className="section-text"> Helps <span>Poor People</span> </h1>
            <p> Phosfluorescently cultivate enabled relationships without sticky practices distinctively empower next-generation e-commerce network </p>
          </div>
          {/* about items */}
          <div className="charina-about-items">
            ...
            <div className="about-item-content">
              ...
              <p>Distinctively empower next-generation charity and idea-sharing and extensible</p>
            </div>
            {/* about icon */}
            <div className="items-icon">
          ...
          <div className="charina-button upp">
            <a href="about.html"> Discover More <i className="bi bi-chevron-double-right" /> </a>
          </div>
        </div>
        {/* about shape */}
      ...
      <div className="row">
        <div className="col-lg-3 col-md-6 pl-0 pr-0">
          <div className="charina-section-title">
            ...
            <h1> We’re here to </h1>
            <h1 className="section-text"> Help <span>Theme</span> </h1>
          </div>
        </div>
          ...
          <div className="service-single-box">
            ...
            <div className="service-content">
              ...
              <div className="right-arrow">
                <a href="service.html"><i className="bi bi-arrow-right" /></a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="row">
        <div className="col-lg-12">
          <div className="charina-section-title white text-center pb-60">
            ...
            <h1> Targated <span>Goals</span> </h1>
          </div>
        </div>
        {/* mission shape */}
  ...
  {/* Start charina mission Section */}
  {/*==================================================*/}
  <div className="vission-sectoin style-two">
    <div className="container">
                ...
                <div className="charina-single-mission-items">
                  ...
                  <div className="charina-mission-content">
                    ...
                    <div className="mission-items-desc">
                      <p>Completely create leveraged best practices and B2B interfaces productivate cutting-edge solutions with go forward supply in a Compellingly supply 24/7 relationships </p>
                    </div>
                    {/* mission service list  */}
                    <div className="mission-list">
                      <ul>
                        <li> <i className="bi bi-check-circle-fill" /> Join Our Charity Team and Helps the </li>
                        <li> <i className="bi bi-check-circle-fill" /> Donate Money for Poor Childreens help </li>
                        <li> <i className="bi bi-check-circle-fill" /> Help for Orphan Kids Healthy foods </li>
                      </ul>
                    </div>
                    {/* mission button */}
                    <div className="mission-button">
                      <a href="events.html"> Doscover More <i className="bi bi-chevron-double-right" /> </a>
                    </div>
                  </div> 
                  {/* / mission content */}
                </div>
              ...
              <div className="tabs_item">
                <div className="charina-single-mission-items">
                  ...
                  <div className="charina-mission-content">
                    ...
                    {/* mission button */}
                    <div className="mission-button">
                      <a href="#"> Doscover More <i className="bi bi-chevron-double-right" /> </a>
                    </div>
                  </div> 
                  {/* / mission content */}
                </div>
  ...
  {/*==================================================*/}
  <div className="volunteers-section style-two">
    <div className="container">
      <div className="row">
        <div className="col-lg-12">
          <div className="charina-section-title text-center pb-50">
            <h4> Our Volunteers </h4>
            <h1> Meet Now our  <span>Volunteers</span> </h1>
          </div>
        </div>
      </div>
      <div className="row">
      ...
      <div className="row align-items-center">
        <div className="col-lg-6 col-md-6">
          <div className="charina-section-title">
            ...
            <h1>Suport Us  For <span>Help</span> </h1>
            <p> Completely create leveraged best practices and B2B interfaces productivate cutting-edge solutions with forward </p>
          </div>
        </div>
        <div className="col-lg-6 col-md-6">
          <div className="row">
