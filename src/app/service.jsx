<div>
  ...
  <div className="about-section">
    <div className="container">
      <div className="row">
        ...
        <div className="col-lg-6 col-md-6 pr-0 pl-4">
  ...
  {/*==================================================*/}
  <div className="mission-sectoin style-two">
    <div className="container">
      <div className="row">
        <div className="col-lg-12">
          ...
          <div className="feature-single-box">
            ...
            <div className="feature-content">
              ...
              <div className="feature-description">
                <p>Leveraged best practices and B2B edge productivate cutting solution</p>
              </div>
            </div>
            <div className="feature-button">
              <a href="service.html"> Read More <i className="bi bi-arrow-right" /></a>
            </div>
          </div>
        </div>
        <div className="col-lg-4 col-md-6">
