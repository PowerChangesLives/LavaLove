      ...
      <div className="row align-items-center">
        ...
        <div className="col-lg-2 pl-0 ">
          ...
          <div className="header-button">
            <a href="service.html"> Donate Now <i className="bi bi-suit-heart" /> </a>	
          </div>
        </div>
      </div>
    </div>
          ...
          <div className="breatcam-content text-center">
            ...
            <div className="breatcam-menu">
              <ul>
                ...
                <li><span>/</span>Become Volunteer </li>
              </ul>
            </div>
            {/* breadcumb title */}
      ...
      <div className="row">
        ...
        <div className="col-lg-6 col-md-6 pr-0">
          <div className="charina-section-title">
            ...
            <h1 className="section-text"> Become a <span>Volunteers</span> </h1>
            <p> Monotonectally enable quality users via stand-alone strategic theme areas. Quickly productize timely synergy with compelling processes. Rapidiously provide access holistic results with user friendly. </p>
          </div>
          {/* charina check list */}
          <div className="charina-check-list upper">
            <p className="charina-icon"> <i className="bi bi-check-circle-fill" /> Completely architect competitive information </p>
            <p className="charina-icon"> <i className="bi bi-check-circle-fill" /> Must be Maintain Every Rules &amp; Regulations </p>
            <p className="charina-icon"> <i className="bi bi-check-circle-fill" /> You should be a honest &amp; powerful </p>
          </div>
          {/* charina button */}
      ...
      <div className="row">
        <div className="col-lg-12">
          <div className="charina-section-title white text-center">
            ...
            <h1 className="section-text"> Biggest <span>Community</span> </h1>
          </div>
        </div>
      </div>
    </div>
