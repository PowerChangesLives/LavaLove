<div>
  ...
  {/*==================================================*/}
  <div className="galary-section style-three gallery-page">
    <div className="container">
      <div className="row">
        <div className="col-lg-4 col-md-6">
          <div className="galary-single-box">
            ...
            <div className="galary-thumb">
              ...
              {/* galary title */}
              <div className="galary-title">
                <h5>Charity</h5>
                <h4><a href="gallery-details.html">Education for Childreen</a></h4>
              </div>
            </div>
          </div>
        </div>
        <div className="col-lg-4 col-md-6">
          <div className="galary-single-box">
            ...
            <div className="galary-thumb">
              ...
              <div className="galary-title">
                <h5>Charity</h5>
                <h4><a href="gallery-details.html">Organic Foods for Kids</a></h4>
              </div>
            </div>
          </div>
        </div>
        <div className="col-lg-4 col-md-6">
          <div className="galary-single-box">
            ...
            <div className="galary-thumb">
              ...
              <div className="galary-title">
                <h5>Charity</h5>
                <h4><a href="gallery-details.html">Donate Homeless Kids</a></h4>
              </div>
            </div>
          </div>
        </div>
        <div className="col-lg-4 col-md-6">
          <div className="galary-single-box">
            ...
            <div className="galary-thumb">
              ...
              <div className="galary-title">
                <h5>Charity</h5>
                <h4><a href="gallery-details.html">Food for Orphan People</a></h4>
              </div>
            </div>
          </div>
        </div>
        <div className="col-lg-4 col-md-6">
          <div className="galary-single-box">
            ...
            <div className="galary-thumb">
              ...
              <div className="galary-title">
                <h5>Charity</h5>
                <h4><a href="gallery-details.html">Donate for Happiness</a></h4>
              </div>
            </div>
          </div>
        </div>
