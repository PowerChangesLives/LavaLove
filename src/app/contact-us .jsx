      ...
      <div className="row">
        <div className="col-lg-12 pb-60">
          <div className="charina-section-title text-center">
            ...
            <h1> Feel free to write us <span>Anytime</span> </h1>
          ...
          <div className="contact-form-box">
            <form action="https://formspree.io/f/myyleorq" method="POST" id="dreamit-form">
              <div className="row">
                ...
                <div className="col-lg-12">
                  <div className="form-box">
                    <textarea name="massage" id="massage" cols={30} rows={10} placeholder="Write Comment" defaultValue={""} />
                  </div>
                </div>
                <div className="col-lg-12">
      ...
      <div className="row">
        <div className="col-lg-12 pb-60">
          <div className="charina-section-title white text-center">
            ...
            <h1> Find Us on Google  <span>Maps</span> </h1>
          </div>
        </div>
      </div>
      <div className="row">
  ...
  <div className="map-section">
    <div className="container">
      <div className="row map-bg">
        <div className="col-lg-12">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3596.6194043224186!2d89.61168491495718!3d25.650754283687256!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39fd33c03fbe69cb%3A0x273671e159f8b39e!2sRDRS%20Ulipur!5e0!3m2!1sen!2sbd!4v1636872467628!5m2!1sen!2sbd" width={1140} height={500} style={{border: 0}} allowFullScreen loading="lazy" />
        </div>
      </div>
    </div>
  </div>
